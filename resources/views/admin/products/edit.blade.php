        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        class="block w-full mt-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                        type="number" step="0.01" name="price" id="price" value="{{ old('price', $product->price) }}">
                </div>
                <div>
            ...
            <div class="mt-4">
                ...
                @if($product->image)
                    <img src="{{ asset('storage/' . $product->image) }}" alt="Current Image"
                        class="w-24 h-24 mt-2 object-cover rounded">
                @endif
            </div>
            ...
            <!-- Custom Form Builder -->
            <div x-data="formBuilder()" x-init="init('{{ old('custom_form_schema', $product->custom_form_schema) }}')">
                <h3 class="text-lg font-medium text-gray-700">Custom Form Builder</h3>
                <p class="mt-1 text-sm text-gray-500">Add or edit custom options for this product.</p>
            ...
            <div class="flex justify-end mt-6">
                <button type="submit"
                    class="px-6 py-2 font-bold text-white bg-indigo-600 rounded-md hover:bg-indigo-700">Update
                    Product</button>
            </div>
        </form>
    </div>
